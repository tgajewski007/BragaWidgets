...
class DateTimeField extends TextField
{
	...
	public function out()
	{
		...
		$input = BaseTags::input("name='" . $this->name . "' value='" . $this->selected . "' autocomplete='off' class='form-control' placeholder='RRRR-MM-DD GG:MM' pattern='(\d{4})-(\d{2})-(\d{2}) (\d{2}):(\d{2})' onfocus='\$(\"#" . $this->id . "\").data(\"DateTimePicker\").show();'");
