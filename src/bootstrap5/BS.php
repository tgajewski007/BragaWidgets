...
{
	// -------------------------------------------------------------------------
	public static function getHeadCssLink()
	{
		return BaseTags::link("rel='stylesheet' type='text/css' href='https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css'");
	}
	// -------------------------------------------------------------------------
	public static function getHeadScript()
	{
		return BaseTags::script("", "type='text/javascript' src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js'");
	}
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	public static function submit($label, $baseClass = Color::BUTTON_COLOR_PRIMARY)
	{
		return BaseTags::input("type='submit' value='" . $label . "' class='btn " . $baseClass . "'");
	}
	// -------------------------------------------------------------------------
	public static function button($content, $attrb, $baseClass = Color::BUTTON_COLOR_PRIMARY)
	{
	...
	public static function listGroupItemAjax($label, $labelHref, $iconHref, $idContener)
	{
		...
		$iconHref = BaseTags::i("", "class='fa fa-caret-right fa-lg fa-fw' onclick='listGroupItemAjax(event, this,\"" . $idContener . "\",\"" . $iconHref . "\");return false;'");
	...
	public static function treeItemList($activeLink, $branchContent)
	{
		...
		$openCloseIcon = BaseTags::i("", "class='fa fa-caret-right fa-lg fa-fw hand' onclick='\$(\"#" . $idContener . "\").toggle(); $(this).toggleClass(\"fa-caret-right\"); $(this).toggleClass(\"fa-caret-down\"); '");
	...
	{
		return "title='" . $txt . "' data-bs-toggle='tooltip' data-bs-placement='" . $position . "'";
	}
	// -------------------------------------------------------------------------
	/**
	 * @param string $label
	...
	// -------------------------------------------------------------------------
	public function badge($content, $class = "badge", $attrib = null)
	{
		return BaseTags::span($content, "class='" . $class . "'");
	}
	// -------------------------------------------------------------------------
}