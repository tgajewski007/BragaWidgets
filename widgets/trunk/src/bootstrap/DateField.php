...
class DateField extends TextField
{
	...
	public function out()
	{
		...
		$label = $this->getLabel();
		return BaseTags::div($label . $retval . $this->getValidationMessage(), "class='" . $class . "'") . BaseTags::script("\$(\"#" . $this->id . "\").datepicker({format:\"yyyy-mm-dd\",language:\"pl\",autoclose:true});");
	}
	// -------------------------------------------------------------------------
}